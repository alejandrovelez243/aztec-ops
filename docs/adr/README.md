...
considered. The table in `docs/ARCHITECTURE.md` §2 is the index of the same eight decisions in
...
| [0003](0003-transactional-outbox-with-redis-streams.md) | Transactional outbox relayed to Redis Streams | Accepted 2026-07-28 |
